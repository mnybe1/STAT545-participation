...
devtools::install_github("JoeyBernhardt/singer") #Install packages from github repo or package instead of cran
```
...
time %>% 
  inner_join(album, by = c("song", "artist_name")) #Include city
```
